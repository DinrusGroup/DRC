...
******************************************************************************
*
* Файл OMF состоит из ряда записей, у которых единая базовая
* структура: 
* 1. Один байт, описывающий тип записи
* 2. 16-битное слово, указывающее на длину остальной записи
* 3. Данные переменного типа и размера (max 1024 байт)
* 4. Один байт для контрольной суммы. Некоторые системы просто ставят здесь 0
*
* Формат OMF разработан для компактности. Все целые типа "index"
* представляются одним байтом, если они не более 127, или двумя, если они
* 128 или более. Самый старший бит первого байта указывает на наличие
* одного или двух байтов. Целые, indicating a segment offset are 16
