...
// Максимальное число файлов-ответов в командной строке
#define MAX_COMMAND_FILES  10

// Константы для типа выходящего файла
#define CMDL_OUTPUT_DUMP          0x80       // Выводного файла нет, просто демпировать контент
#define CMDL_OUTPUT_ELF    FILETYPE_ELF      // файл ELF
#define CMDL_OUTPUT_PE     FILETYPE_COFF     // файл MS-COFF/PE
#define CMDL_OUTPUT_OMF    FILETYPE_OMF      // файл OMF
#define CMDL_OUTPUT_MACHO  FILETYPE_MACHO_LE // файл Mach-O, little endian
#define CMDL_OUTPUT_MASM   FILETYPE_ASM      // Дизассемблировать

// Константы для подтипов
#define SUBTYPE_MASM                 0       // Дизассемблировать MASM/TASM
