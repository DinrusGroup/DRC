...
// Cast a ткст literal to a ubyte*=PCHAR
...
enum { RASP_Amb = 0x10000, RASP_PppNbf = 0x803F, RASP_PppИПx = 0x802B, RASP_PppИП = 0x8021,  };
...
extern(Windows)
{
    alias UINT (*LPFNPSPCALLBACK)(HWND, UINT, LPVOID);
}
...
extern(Windows)
{
	...
	WINBOOL SendMessageCallbackA(HWND, UINT, WPARAM, LPARAM, base.SENDASYNCPROC, DWORD);
	...
	WINBOOL GrayStringA(HDC, HBRUSH, base.GRAYSTRINGPROC, LPARAM, int, int, int, int, int);
	WINBOOL DrawStateA(HDC, HBRUSH, base.DRAWSTATEPROC, LPARAM, WPARAM, int, int, int, int, UINT);
	...
	WINBOOL SendMessageCallbackW(HWND, UINT, WPARAM, LPARAM, base.SENDASYNCPROC, DWORD);
	...
	WINBOOL GrayStringW(HDC, HBRUSH, base.GRAYSTRINGPROC, LPARAM, int, int, int, int, int);
	WINBOOL DrawStateW(HDC, HBRUSH, base.DRAWSTATEPROC, LPARAM, WPARAM, int, int, int, int, UINT);
