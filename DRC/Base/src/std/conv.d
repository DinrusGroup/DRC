...
unittest
{
    debug(conv) эхо("conv.toInt.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toUint.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toLong.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toUlong.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toShort.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toUshort.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toByte.unittest\n");
...
unittest
{
    debug(conv) эхо("conv.toUbyte.unittest\n");
