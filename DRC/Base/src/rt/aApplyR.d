...
export extern (C) int _aApplyRcd1(in char[] aa, dg_t dg)
{   int результат;
    ...
    {   dchar d;
        ...
        {   char c = cast(char)d;
            ...
            while ((c & 0xC0) != 0xC0)
            {   if (i == 0)
                    onUnicodeError("_aApplyRcd1: Неверная последовательность UTF-8", 0);
                i--;
                d |= (c & 0x3F) << j;
                j += 6;
                m >>= 1;
...
export extern (C) int _aApplyRwd1(in wchar[] aa, dg_t dg)
{   int результат;
    ...
    {   dchar d;
        ...
        {   if (i == 0)
                onUnicodeError("_aApplyRwd1: Неверная последовательность UTF-16", 0);
            i--;
...
export extern (C) int _aApplyRcw1(in char[] aa, dg_t dg)
{   int результат;
    ...
    {   dchar d;
        ...
        {   char c = cast(char)w;
            ...
            while ((c & 0xC0) != 0xC0)
            {   if (i == 0)
                    onUnicodeError("_aApplyRcw1: Неверная последовательность UTF-8", 0);
                i--;
                d |= (c & 0x3F) << j;
                j += 6;
                m >>= 1;
...
export extern (C) int _aApplyRwc1(in wchar[] aa, dg_t dg)
{   int результат;
    ...
    {   dchar d;
        ...
        if (d >= 0xDC00 && d <= 0xDFFF)
        {   if (i == 0)
                onUnicodeError("_aApplyRwc1: Неверная последовательность UTF-16", 0);
            i--;
            d = ((aa[i] - 0xD7C0) << 10) + (d - 0xDC00);
        }
...
export extern (C) int _aApplyRdc1(in dchar[] aa, dg_t dg)
{   int результат;
...
export extern (C) int _aApplyRdw1(in dchar[] aa, dg_t dg)
{   int результат;
...
export extern (C) int _aApplyRcd2(in char[] aa, dg2_t dg)
{   int результат;
    size_t i;
    ...
    {   dchar d;
        ...
        {   char c = cast(char)d;
            ...
            while ((c & 0xC0) != 0xC0)
            {   if (i == 0)
                    onUnicodeError("Неверная последовательность UTF-8", 0);
                i--;
                d |= (c & 0x3F) << j;
                j += 6;
                m >>= 1;
...
export extern (C) int _aApplyRwd2(in wchar[] aa, dg2_t dg)
{   int результат;
...
export extern (C) int _aApplyRcw2(in char[] aa, dg2_t dg)
{   int результат;
...
export extern (C) int _aApplyRwc2(in wchar[] aa, dg2_t dg)
{   int результат;
    ...
    {   dchar d;
        ...
        if (d >= 0xDC00 && d <= 0xDFFF)
        {   if (i == 0)
                onUnicodeError("Неверная последовательность UTF-16", 0);
            i--;
            d = ((aa[i] - 0xD7C0) << 10) + (d - 0xDC00);
        }
...
export extern (C) int _aApplyRdc2(in dchar[] aa, dg2_t dg)
{   int результат;
...
export extern (C) int _aApplyRdw2(in dchar[] aa, dg2_t dg)
{   int результат;
