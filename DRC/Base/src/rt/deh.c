...
/*__declspec(dllexport)*/ Object *_d_create_exception_object(ClassInfo *ci, char *msg)
{
    Exception *exc;
...
/*__declspec(dllexport)*/ Object *_d_translate_se_to_d_exception(EXCEPTION_RECORD *exception_record)
{
    Object *pti;
...
/*__declspec(dllexport)*/ void __cdecl _d_local_unwind(struct DHandlerTable *handler_table,
...
/*__declspec(dllexport)*/ __declspec(naked) void __cdecl _d_local_unwind2()
{
    __asm
    {
	jmp	_d_local_unwind
 ...
 */
 ...
 /*__declspec(dllexport)*/ EXCEPTION_DISPOSITION _d_monitor_handler(
	    EXCEPTION_RECORD *exception_record, 
	    struct DEstablisherFrame *frame, 
	    CONTEXT *context,
	    void *dispatcher_context)
 ...
 */
 ...
 /*__declspec(dllexport)*/ void _d_monitor_prolog(void *x, void *y, Object *h)
{
    __asm
    {
	push	EAX
 ...
 */
 ...
 /*__declspec(dllexport)*/ void _d_monitor_epilog(void *x, void *y, Object *h)
{
 ...
 */
 ...
 /*__declspec(dllexport)*/ struct DHandlerTable *__eh_finddata(void *address)
{
    struct FuncTable *ft;
 ...
 */
 ...
 /*__declspec(dllexport)*/ unsigned __eh_find_caller(unsigned regbp, unsigned *pretaddr)
{
...
void __stdcall _d_throw(Object *h)
{
 ...
 ///*__declspec(dllexport)*/ void  _stdcall dothrow(Object *h){_d_throw(h);}