...
/*__declspec(dllexport)*/ void _STI_monitor_staticctor()
{
    if (!inited)
...
/*__declspec(dllexport)*/ void _STD_monitor_staticdtor()
{
    if (inited)
    {	inited = 0;
...
/*__declspec(dllexport)*/ void _d_monitorrelease(Object *h)
{
    if (h->monitor)
    {
	_d_notify_release(h);
...
/*__declspec(dllexport)*/ void _d_monitor_create(Object *h)
{
    /*
...
/*__declspec(dllexport)*/ void _d_monitor_destroy(Object *h)
{
...
/*__declspec(dllexport)*/ int _d_monitor_lock(Object *h)
{
...
/*__declspec(dllexport)*/ void _d_monitor_unlock(Object *h)
{
