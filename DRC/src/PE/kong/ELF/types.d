/*
 ...
 file : kong.ELF.types : from gnu/linux elf.h
*/
module kong.ELF.types;
...
template ELF_types(int CLASS)
{
    static if (CLASS == ELFCLASS32)
    {
        alias Elf32_Ehdr    _Ehdr;
        alias Elf32_Phdr    _Phdr;
        alias Elf32_Shdr    _Shdr;
        alias Elf32_Sym     _Sym;
        alias Elf32_Rel     _Rel;
        alias Elf32_Rela    _Rela;
        alias Elf32_Dyn     _Dyn;
        alias Elf32_Addr    _Addr;
        alias Elf32_Word    _Word;
        alias Elf32_Half    _Half;
        alias Elf32_Off     _Off;
        /*
        alias ELF32_R_SYM   _CLASS_R_SYM;
        alias ELF32_R_TYPE  _CLASS_R_TYPE;
        alias ELF32_ST_TYPE _CLASS_ST_TYPE;
        alias ELF32_ST_BIND _CLASS_ST_BIND;*/
    }
    static if (CLASS == ELFCLASS64)
    {
        alias Elf64_Ehdr    _Ehdr;
        alias Elf64_Phdr    _Phdr;
        alias Elf64_Shdr    _Shdr;
        alias Elf64_Sym     _Sym;
        alias Elf64_Rel     _Rel;
        alias Elf64_Rela    _Rela;
        alias Elf64_Dyn     _Dyn;
        alias Elf64_Addr    _Addr;
        alias Elf64_Half    _Half;
        alias Elf64_Word    _Word;
        alias Elf64_Off     _Off;
        /*
        alias ELF64_R_SYM   _CLASS_R_SYM;
        alias ELF64_R_TYPE  _CLASS_R_TYPE;
        alias ELF64_ST_TYPE _CLASS_ST_TYPE;
        alias ELF64_ST_BIND _CLASS_ST_BIND;*/
    }
}


// --------------------------------------------------------
/* Converted to D from elf.h by htod
 * find/replace: struct *^p^({^p*^p}^)^palias * ^(*^);
 *               struct ^2^p^1^p
 */
...
template ELFMAG()
    { const ubyte[] ELFMAG = [ ELFMAG0, ELFMAG1, ELFMAG2, ELFMAG3 ]; }
...
/* Symbol table indices are found in the hash hash_buckets and chain table
...
enum { HWCAP_SPARC_FLUSH = 1 }
enum { HWCAP_SPARC_STBAR = 2 }
enum { HWCAP_SPARC_SWAP = 4 }
enum { HWCAP_SPARC_MULDIV = 8 }
enum { HWCAP_SPARC_V9 = 16 }
enum { HWCAP_SPARC_ULTRA3 = 32 }

enum { HWCAP_SPARC_BLKINIT = 64 }
...
enum { EF_MIPS_ARCH_32 = 0x60000000 }

enum { EF_MIPS_ARCH_64 = 0x70000000 }
/* The following are non-official names and should not be used.  */

enum { E_MIPS_ARCH_1 = 0x00000000 }
enum { E_MIPS_ARCH_2 = 0x10000000 }
enum { E_MIPS_ARCH_3 = 0x20000000 }
enum { E_MIPS_ARCH_4 = 0x30000000 }
enum { E_MIPS_ARCH_5 = 0x40000000 }
enum { E_MIPS_ARCH_32 = 0x60000000 }

enum { E_MIPS_ARCH_64 = 0x70000000 }
/* Special section indices.  */
...
alias OEX_FPDBUG OEX_PRECISEFP;
...
alias R_PARISC_TPREL21L R_PARISC_TLS_LE21L;
alias R_PARISC_TPREL14R R_PARISC_TLS_LE14R;
alias R_PARISC_LTOFF_TP21L R_PARISC_TLS_IE21L;
alias R_PARISC_LTOFF_TP14R R_PARISC_TLS_IE14R;
alias R_PARISC_TPREL32 R_PARISC_TLS_TPREL32;

alias R_PARISC_TPREL64 R_PARISC_TLS_TPREL64;
...
alias R_PPC_NONE R_PPC64_NONE;
alias R_PPC_ADDR32 R_PPC64_ADDR32;
alias R_PPC_ADDR24 R_PPC64_ADDR24;
alias R_PPC_ADDR16 R_PPC64_ADDR16;
alias R_PPC_ADDR16_LO R_PPC64_ADDR16_LO;
alias R_PPC_ADDR16_HI R_PPC64_ADDR16_HI;
alias R_PPC_ADDR16_HA R_PPC64_ADDR16_HA;
alias R_PPC_ADDR14 R_PPC64_ADDR14;
alias R_PPC_ADDR14_BRTAKEN R_PPC64_ADDR14_BRTAKEN;
alias R_PPC_ADDR14_BRNTAKEN R_PPC64_ADDR14_BRNTAKEN;
alias R_PPC_REL24 R_PPC64_REL24;
alias R_PPC_REL14 R_PPC64_REL14;
alias R_PPC_REL14_BRTAKEN R_PPC64_REL14_BRTAKEN;
alias R_PPC_REL14_BRNTAKEN R_PPC64_REL14_BRNTAKEN;
alias R_PPC_GOT16 R_PPC64_GOT16;
alias R_PPC_GOT16_LO R_PPC64_GOT16_LO;
alias R_PPC_GOT16_HI R_PPC64_GOT16_HI;

alias R_PPC_GOT16_HA R_PPC64_GOT16_HA;
alias R_PPC_COPY R_PPC64_COPY;
alias R_PPC_GLOB_DAT R_PPC64_GLOB_DAT;
alias R_PPC_JMP_SLOT R_PPC64_JMP_SLOT;

alias R_PPC_RELATIVE R_PPC64_RELATIVE;
alias R_PPC_UADDR32 R_PPC64_UADDR32;
alias R_PPC_UADDR16 R_PPC64_UADDR16;
alias R_PPC_REL32 R_PPC64_REL32;
alias R_PPC_PLT32 R_PPC64_PLT32;
alias R_PPC_PLTREL32 R_PPC64_PLTREL32;
alias R_PPC_PLT16_LO R_PPC64_PLT16_LO;
alias R_PPC_PLT16_HI R_PPC64_PLT16_HI;

alias R_PPC_PLT16_HA R_PPC64_PLT16_HA;
alias R_PPC_SECTOFF R_PPC64_SECTOFF;
alias R_PPC_SECTOFF_LO R_PPC64_SECTOFF_LO;
alias R_PPC_SECTOFF_HI R_PPC64_SECTOFF_HI;
alias R_PPC_SECTOFF_HA R_PPC64_SECTOFF_HA;
