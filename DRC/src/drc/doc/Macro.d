...
class ТаблицаМакросов
{
  ...
  /// Overwrites the current macro if one есть_ли.
...
struct РаскрывательМакросов
{
  ...
  ткст путьКФайлу; /// Used in предупреждение сообщения.
  ...
  проц  предупреждение(ткст сооб, ткст macroName)
  {
  ...
  ткст раскройМакрос(ткст текст, ткст предшArg0 = null/+, бцел depth = 1000+/)
  {
    // if (depth == 0)
    //   return  текст;
    // depth--;
